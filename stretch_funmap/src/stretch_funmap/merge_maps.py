...
def estimate_scan_1_to_scan_2_transform(scan_1, scan_2, display_on=False, show_unaligned=False,
    ...
    registration, cost = register_images(mhi_to_warp, mhi_target, mhi_to_warp_center,
                                         ...
                                         init_target_x=init_target[0], init_target_y=init_target[1],
                                         init_angle_deg=init_target[2],
    ...
    combined_robot_x_pix, combined_robot_y_pix = affine_transform_2d_point(affine_matrix, (
    map_to_warp_robot_x_pix, map_to_warp_robot_y_pix))
    combined_robot_theta_rad = map_to_warp_robot_theta_rad + ((np.pi / 180.0) * angle_deg)
    combined_robot_pose = {'x_pix': combined_robot_x_pix, 'y_pix': combined_robot_y_pix,
                           'theta_rad': combined_robot_theta_rad}
    ...
    x, y, a = transform_xya_to_xya_3d(scan_2.image_to_map_mat, scan_1.robot_xy_pix[0], scan_1.robot_xy_pix[1],
                                      scan_1.robot_ang_rad)
...
def merge_scan_1_into_scan_2(scan_1, scan_2, display_on=False, show_unaligned=False,
    ...
    affine_matrix, original_robot_map_pose, corrected_robot_map_pose = estimate_scan_1_to_scan_2_transform(scan_1,
                                                                                                           scan_2,
