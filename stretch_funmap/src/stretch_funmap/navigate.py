...
class FastSingleViewPlanner():
    ...
    def plan_a_path(self, end_xyz, end_frame_id, tf2_buffer, floor_mask=None):
        if self.updated:
            ...
            line_segment_path, message = na.plan_a_path(self.max_height_im, robot_xya_pix, end_xy_pix,
...
class MoveBase():
    def __init__(self, node, debug_directory=None):
        ...
        self.node = node
        self.unsuccessful_status = [GoalStatus.PREEMPTED, GoalStatus.ABORTED, GoalStatus.REJECTED, GoalStatus.RECALLED,
                                    GoalStatus.LOST]
    ...
    def local_plan(self, end_xyz, end_frame_id):
        ...
        line_segment_path, frame_id = self.local_planner.plan_a_path(end_xyz, end_frame_id, self.node.tf2_buffer,
                                                                     floor_mask=None)
    ...
    def backward(self, distance_m, publish_visualizations=True,
        ...
        self.forward(distance_m, publish_visualizations=publish_visualizations,
                     tolerance_distance_m=tolerance_distance_m, max_forward_attempts=max_forward_attempts,
