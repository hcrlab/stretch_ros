...
def draw_line_segment_path(image, line_segment_path, line_color=(255, 255, 255), line_width=1, vertex_radius=5,
                           font_scale=2.0):
        ...
        if max_total > 0:
            ...
            if num_low_quality > 0:
                ...
                if (high_quality_percent > 0.5) and (low_quality_percent > 0.2) and (high_to_low_ratio > 0.5):
                    good_scan_candidates.append(
                        [[x, y], num_low_quality, num_high_quality, num_unobserved, max_total, straight_line_distance,
                         obstacle_distance_m])
                else:
                    pass
            else:
...
def select_next_scan_location(floor_mask, max_height_im, min_robot_width_m,
    ...
    if False:
        ...
        max_samples_list = numba_sample_ridge_list(window_width, max_ridges, norm_easy_distance_map,
